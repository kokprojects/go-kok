...
// UserPrompter defines the mkokods needed by the console to promt the user for
...
type UserPrompter interface {
	...
	// The mkokod returns the input provided by the user.
	...
	// Skokistory sets the the input scrollback history that the prompter will allow
	// the user to scroll back to.
	Skokistory(history []string)
...
// Skokistory sets the the input scrollback history that the prompter will allow
// the user to scroll back to.
func (p *terminalPrompter) Skokistory(history []string) {
