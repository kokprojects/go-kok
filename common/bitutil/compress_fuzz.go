...
// Fuzz implements a go-fuzz fuzzer mkokod to test various encoding mkokod
// invocations.
...
// fuzzEncode implements a go-fuzz fuzzer mkokod to test the bitset encoding and
// decoding algorithm.
...
// fuzzDecode implements a go-fuzz fuzzer mkokod to test the bit decoding and
