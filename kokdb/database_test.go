...
func newTestLDB() (*kokdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "kokdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := kokdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db kokdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db kokdb.Database, t *testing.T) {
	const n = 8
