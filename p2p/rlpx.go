...
import (
	...
	"github.com/kokprojects/go-kok/crypto/secp256k1"
...
// and also verifies whkoker the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whkoker read packet had plain format.
