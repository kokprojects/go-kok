...
// Contains reports whkoker the given IP is contained in the list.
...
// IsLAN reports whkoker an IP is a local network address.
...
// IsSpecialNetwork reports whkoker an IP is located in a special-use network range
...
// CheckRelayIP reports whkoker an IP relayed from the given sender IP
