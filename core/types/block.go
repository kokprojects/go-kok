...
// Package types contains data types related to kokereum consensus.
package types
...
// a block's data contents (transactions and uncles) togkoker.
type Body struct {
...
type Block struct {
	...
	// These fields are used by package kok to track
...
// [deprecated by kok/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for kok protocol, etc.
...
// DecodeRLP decodes the kokereum
...
// EncodeRLP serializes b into the kokereum RLP block format.
