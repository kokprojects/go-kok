...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb, _ := kokdb.NewMemDatabase()
	finalDb, _ := kokdb.NewMemDatabase()
...
// accessor mkokods on the reverted state must match the return value of the equivalent
// mkokods on the replayed state.
...
// checkEqual checks that mkokods of state and checkstate return the same values.
