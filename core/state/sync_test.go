...
func makeTestState() (Database, *kokdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := kokdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db kokdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db kokdb.Database, root common.Hash) error {
...
func checkStateConsistency(db kokdb.Database, root common.Hash) error {
