...
// cacheSize calculates and returns the size of the kokash verification cache that
...
// datasetSize calculates and returns the size of the kokash mining dataset that
