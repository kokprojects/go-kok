...
// Contains all the wrappers from the go-kokereum root package.
...
type SyncProgress struct {
	progress kokereum.SyncProgress
}
...
func (p *SyncProgress) GkokighestBlock() int64  { return int64(p.progress.HighestBlock) }
