...
// Package chequebook package wraps the 'chequebook' kokereum smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in koker; (auto)cashing cheques in koker
// as well as (auto)depositing koker to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/kokprojects/go-kok/contracts/chequebook/contract"
	"github.com/kokprojects/go-kok/core/types"
	"github.com/kokprojects/go-kok/crypto"
	"github.com/kokprojects/go-kok/log"
	"github.com/kokprojects/go-kok/swarm/services/swap/swap"
)
...
// * depositing koker to the chequebook
// * watching incoming koker
...
// Backend wraps all mkokods required for chequebook operation.
...
// Cash is a convenience mkokod to cash any cheque.
...
// Cash cashes the cheque by sending an kokereum transaction.
