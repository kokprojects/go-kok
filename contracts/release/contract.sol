...
// ReleaseOracle is an kokereum contract to store the current and previous
// versions of the go-kokereum implementation. Its goal is to allow Gkok to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Gkok releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Gkok release
  struct Version {
  ...
  // signers is an accessor mkokod to retrieve all te signers (public accessor
  ...
  // updateSigner marks a vote for changing the status of an kokereum user, either
