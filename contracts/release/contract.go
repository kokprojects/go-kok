...
// DeployReleaseOracle deploys a new kokereum contract, binding an instance of ReleaseOracle to it.
...
// ReleaseOracle is an auto generated Go binding around an kokereum contract.
...
// ReleaseOracleCaller is an auto generated read-only Go binding around an kokereum contract.
type ReleaseOracleCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ReleaseOracleTransactor is an auto generated write-only Go binding around an kokereum contract.
type ReleaseOracleTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ReleaseOracleSession is an auto generated Go binding around an kokereum contract,
...
// ReleaseOracleCallerSession is an auto generated read-only Go binding around an kokereum contract,
...
// ReleaseOracleTransactorSession is an auto generated write-only Go binding around an kokereum contract,
...
// ReleaseOracleRaw is an auto generated low-level Go binding around an kokereum contract.
type ReleaseOracleRaw struct {
	Contract *ReleaseOracle // Generic contract binding to access the raw mkokods on
}

// ReleaseOracleCallerRaw is an auto generated low-level read-only Go binding around an kokereum contract.
type ReleaseOracleCallerRaw struct {
	Contract *ReleaseOracleCaller // Generic read-only contract binding to access the raw mkokods on
}

// ReleaseOracleTransactorRaw is an auto generated low-level write-only Go binding around an kokereum contract.
type ReleaseOracleTransactorRaw struct {
	Contract *ReleaseOracleTransactor // Generic write-only contract binding to access the raw mkokods on
}
...
// returns.
func (_ReleaseOracle *ReleaseOracleRaw) Call(opts *bind.CallOpts, result interface{}, mkokod string, params ...interface{}) error {
	return _ReleaseOracle.Contract.ReleaseOracleCaller.contract.Call(opts, result, mkokod, params...)
}
...
func (_ReleaseOracle *ReleaseOracleRaw) Transact(opts *bind.TransactOpts, mkokod string, params ...interface{}) (*types.Transaction, error) {
	return _ReleaseOracle.Contract.ReleaseOracleTransactor.contract.Transact(opts, mkokod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_ReleaseOracle *ReleaseOracleCallerRaw) Call(opts *bind.CallOpts, result interface{}, mkokod string, params ...interface{}) error {
	return _ReleaseOracle.Contract.contract.Call(opts, result, mkokod, params...)
}
...
// Transact invokes the (paid) contract mkokod with params as input values.
func (_ReleaseOracle *ReleaseOracleTransactorRaw) Transact(opts *bind.TransactOpts, mkokod string, params ...interface{}) (*types.Transaction, error) {
	return _ReleaseOracle.Contract.contract.Transact(opts, mkokod, params...)
}

// AuthProposals is a free data retrieval call binding the contract mkokod 0xbf8ecf9c.
//
...
// AuthVotes is a free data retrieval call binding the contract mkokod 0x64ed31fe.
//
...
// CurrentVersion is a free data retrieval call binding the contract mkokod 0x9d888e86.
//
...
// ProposedVersion is a free data retrieval call binding the contract mkokod 0x26db7648.
//
...
// Signers is a free data retrieval call binding the contract mkokod 0x46f0975a.
//
...
// Demote is a paid mutator transaction binding the contract mkokod 0x5c3d005d.
//
...
// Nuke is a paid mutator transaction binding the contract mkokod 0xbc8fbbf8.
//
...
// Promote is a paid mutator transaction binding the contract mkokod 0xd0e0813a.
//
...
// Release is a paid mutator transaction binding the contract mkokod 0xd67cbec9.
//
