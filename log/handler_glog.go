...
type GlogHandler struct {
	...
	override  uint32 // Flag whkoker overrides are used, atomically accessible
	backtrace uint32 // Flag whkoker backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whkoker this is the callsite
