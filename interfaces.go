...
// Package kokereum defines interfaces for interacting with kokereum.
package kokereum
...
// NotFound is returned by API mkokods if the requested item does not exist.
...
// ChainReader provides access to the blockchain. The mkokods in this interface access raw
...
type ChainReader interface {
	...
	// This mkokod subscribes to notifications about changes of the head block of
	// the canonical chain.
...
type TransactionReader interface {
	...
	// blockchain. The isPending return value indicates whkoker the transaction has been
...
type CallMsg struct {
	...
	Data     []byte          // input data, usually an ABI-encoded contract mkokod invocation
}

// A ContractCaller provides contract calls, essentially transactions that are executed by
// the EVM but not mined into the blockchain. ContractCall is a low-level mkokod to
...
// TransactionSender wraps transaction sending. The SendTransaction mkokod injects a
// signed transaction into the pending transaction pool for execution. If the transaction
// was a contract creation, the TransactionReceipt mkokod can be used to retrieve the
