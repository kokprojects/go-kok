...
type ChainConfig struct {
	...
	DAOForkSupport bool     `json:"daoForkSupport,omitempty"` // Whkoker the nodes supports or opposes the DAO hard-fork

	// EIP150 implements the Gas price changes (https://github.com/kokereum/EIPs/issues/150)
...
// IsHomestead returns whkoker num is either equal to the homestead block or greater.
func (c *ChainConfig) IsHomestead(num *big.Int) bool {
	return isForked(c.HomesteadBlock, num)
}

// IsDAO returns whkoker num is either equal to the DAO fork block or greater.
...
// CheckCompatible checks whkoker scheduled fork transitions have been imported
...
// isForked returns whkoker a fork scheduled at block s is active at the given head block.
