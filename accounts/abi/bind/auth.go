...
// NewTransactor is a utility mkokod to easily create a transaction signer from
...
// NewKeyedTransactor is a utility mkokod to easily create a transaction signer
