...
// Syncing provides information when this nodes starts synchronising with the kokereum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  kokereum.SyncProgress `json:"status"`
}
