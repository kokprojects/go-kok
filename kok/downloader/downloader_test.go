...
type downloadTester struct {
	...
	stateDb kokdb.Database // Database used by the tester for syncing from peers
	peerDb  kokdb.Database // Database of the peers containing all data
...
func (dl *downloadTester) HasHeader(hash common.Hash, number uint64) bool {
	return dl.GkokeaderByHash(hash) != nil
}
...
// Gkokeader retrieves a header from the testers canonical chain.
func (dl *downloadTester) GkokeaderByHash(hash common.Hash) *types.Header {
	dl.lock.RLock()
...
// RequestBodies constructs a getBlockBodies mkokod associated with a particular
...
// RequestReceipts constructs a getReceipts mkokod associated with a particular
// peer in the download tester. The returned function can be used to retrieve
...
// RequestNodeData constructs a getNodeData mkokod associated with a particular
// peer in the download tester. The returned function can be used to retrieve
