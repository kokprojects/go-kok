...
import (
	...
	"github.com/kokprojects/go-kok/swarm/network/kademlia"
	"github.com/kokprojects/go-kok/swarm/services/swap"
...
Timeout serves to indicate whkoker the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whkoker responder is expected to deliver content
