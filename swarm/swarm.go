...
import (
	...
	"github.com/kokprojects/go-kok/contracts/chequebook"
	...
	"github.com/kokprojects/go-kok/swarm/api"
	httpapi "github.com/kokprojects/go-kok/swarm/api/http"
	"github.com/kokprojects/go-kok/swarm/fuse"
	"github.com/kokprojects/go-kok/swarm/network"
	"github.com/kokprojects/go-kok/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *kokclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
