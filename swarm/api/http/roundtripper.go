...
see https://github.com/kokprojects/go-kok/issues/2040
Usage:

import (
 "github.com/kokprojects/go-kok/common/httpclient"
 "github.com/kokprojects/go-kok/swarm/api/http"
)
...
func (self *RoundTripper) RoundTrip(req *http.Request) (resp *http.Response, err error) {
	...
	reqProxy, err := http.NewRequest(req.Mkokod, url, req.Body)
	if err != nil {
		return nil, err
	}
