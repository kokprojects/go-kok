...
// See https://github.com/kokereum/EIPs/issues/176 for the test format specification.
...
func (t *StateTest) Run(subtest StateSubtest, vmconfig vm.Config) (*state.StateDB, error) {
	...
	context.Gkokash = vmTestBlockHash
...
func makePreState(db kokdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/kokereum/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
