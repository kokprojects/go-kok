...
type request struct {
	...
	raw  bool        // Whkoker this is a raw entry (code) or a trie node
...
func (s *TrieSync) AddSubTrie(root common.Hash, depth int, parent common.Hash, callback TrieSyncLeafCallback) {
	...
	// If this sub-trie has a designated parent, link them togkoker
...
// as is. This mkokod's goal is to support misc state metadata retrievals (e.g.
// contract code).
...
// Process injects a batch of retrieved trie nodes data, returning if somkoking
...
func (s *TrieSync) children(req *request, object node) ([]*request, error) {
	// Gather all the children of the node, irrelevant whkoker known or not
	type child struct {
		node  node
		depth int
	}
