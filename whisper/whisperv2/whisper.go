...
import (
	...
	"github.com/kokprojects/go-kok/crypto/ecies"
	"github.com/kokprojects/go-kok/event/filter"
...
// Whisper represents a dark communication interface through the kokereum
...
type Whisper struct {
	...
	expirations map[uint32]*set.SetNonTS  // Message expiration pool (TODO: somkoking lighter)
...
// New creates a Whisper client ready to communicate through the kokereum P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
