...
type LesOdrRequest interface {
	...
	Validate(kokdb.Database, *Msg) error
}
...
func (r *BlockRequest) Validate(db kokdb.Database, msg *Msg) error {
	...
	header := core.Gkokeader(db, r.Hash, r.Number)
	if header == nil {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ReceiptsRequest) Validate(db kokdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *TrieRequest) Validate(db kokdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *CodeRequest) Validate(db kokdb.Database, msg *Msg) error {
...
func (r *ChtRequest) GetCost(peer *peer) uint64 {
	switch peer.version {
	case lpv1:
		return peer.GetRequestCost(GkokeaderProofsMsg, 1)
	case lpv2:
		return peer.GetRequestCost(GkokelperTrieProofsMsg, 1)
	default:
		panic(nil)
	}
}
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ChtRequest) Validate(db kokdb.Database, msg *Msg) error {
...
func (r *BloomRequest) GetCost(peer *peer) uint64 {
	return peer.GetRequestCost(GkokelperTrieProofsMsg, len(r.SectionIdxList))
}
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *BloomRequest) Validate(db kokdb.Database, msg *Msg) error {
