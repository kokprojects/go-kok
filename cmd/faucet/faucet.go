...
import (
	...
	"github.com/kokprojects/go-kok/eth/downloader"
	"github.com/kokprojects/go-kok/ethclient"
	"github.com/kokprojects/go-kok/ethstats"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/kokprojects/go-kok/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
