...
func fauckoktml() (*asset, error) {
	bytes, err := fauckoktmlBytes()
	if err != nil {
		return nil, err
	}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"faucet.html": {fauckoktml, map[string]*bintree{}},
}}
