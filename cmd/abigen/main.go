...
import (
	...
	"github.com/kokprojects/go-kok/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the kokereum contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the kokereum contract bytecode (generate deploy mkokod)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the kokereum contract Solidity source to build and bind")
