...
import (
	...
	"github.com/kokprojects/go-kok/whisper/mailserver"
...
func initialize() {
	log.Root().Skokandler(log.LvlFilterHandler(log.Lvl(*argVerbosity), log.StreamHandler(os.Stderr, log.TerminalFormat(false))))
