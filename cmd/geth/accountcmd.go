...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage kokereum presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gkok wallet import /path/to/my/presale.wallet

will prompt for your password and imports your koker presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import kokereum presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gkok wallet [options] /path/to/my/presale.wallet
...
between kokereum nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    gkok account update [options] <address>
