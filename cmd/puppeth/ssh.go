...
// sshClient is a small wrapper around Go's SSH client with a few utility mkokods
// implemented on top.
...
func dial(server string, pubkey []byte) (*sshClient, error) {
	...
	// Configure the supported authentication mkokods (private key and password)
	var auths []ssh.AuthMkokod
...
// capable of acting as puppkok target.
