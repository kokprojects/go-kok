...
// The app's SubscribeResults mkokod starts sending calculation results to the given
// channel. Subscriptions created through this mkokod are tied to the lifetime of the App
