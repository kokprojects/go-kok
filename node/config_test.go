...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gkok.ipc", false, filepath.Join(os.TempDir(), "gkok.ipc")},
		{"data", "gkok.ipc", false, "data/gkok.ipc"},
		{"data", "./gkok.ipc", false, "./gkok.ipc"},
		{"data", "/gkok.ipc", false, "/gkok.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gkok.ipc", true, `\\.\pipe\gkok.ipc`},
		{"data", "gkok.ipc", true, `\\.\pipe\gkok.ipc`},
		{"data", `\\.\pipe\gkok.ipc`, true, `\\.\pipe\gkok.ipc`},
	}
